...
<div class="right">
	...
	<div class="providerView">
		...
		<p>
			...
			<span><img alt="企业营业执照" src="${pageContext.request.contextPath}/statics/providerphoto/${provider.companyLicPicPath}" height="50px"></span>
		</p>
		<p>
			<strong>企业营业执照：</strong>
			<span><img alt="组织机构代码证" src="${pageContext.request.contextPath}/statics/providerphoto/${provider.orgCodePicPath}" height="50px"></span>
		</p>
