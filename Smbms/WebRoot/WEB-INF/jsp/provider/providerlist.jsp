...
<div class="right">
	...
	<div class="search">
		<form method="post" action="${pageContext.request.contextPath }/provider/findProviders">
			<span>供应商编码：</span>
	...
	<table class="providerTable" cellpadding="0" cellspacing="0">
		...
		<c:forEach var="provider" items="${providers}">
			<tr>
				...
				<td>
					<span><a class="viewProvider" href="${pageContext.request.contextPath}/provider/providerview.html?providerId=${provider.id}">
						<img src="${pageContext.request.contextPath }/statics/images/read.png" alt="查看" title="查看"/>
					</a></span>
					<span><a class="modifyProvider" href="${pageContext.request.contextPath}/provider/modifyprovider.html?providerId=${provider.id}">
						<img src="${pageContext.request.contextPath }/statics/images/xiugai.png" alt="修改" title="修改"/>
					</a></span>
					<span><a class="deleteProvider" href="javascript:;" proid=${provider.id } proname=${provider.proName }>
