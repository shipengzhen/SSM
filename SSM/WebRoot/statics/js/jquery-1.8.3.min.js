...
(function(e, t) {
	...
	v.fn = v.prototype = {
		...
		if (!r) {
			...
			else if (i.addEventListener) i.addEventListener("DOMContentLoaded", A, !1), e.addEventListener("load", v.ready, !1);else {
			...
			for (; (i = e[o]) != null; o++)
				if (t || v.acceptData(i)) {
					...
					if (n) {
						...
						, f ?
							delete i[u]
							: i.removeAttribute ? i.removeAttribute(u) : i[u] = null, v.deletedIds.push(r))
					}
			}
		}
	}), function() {
